...
if __name__ == '__main__':
    ...
    try:
        ...
        Group_Type = browser.find_element(By.XPATH, '//*[@id="side-menu"]/li[13]/ul/li[3]/a')
        browser.execute_script("arguments[0].click();", Group_Type )

        print("[{}] Click Group Type !".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")))
        ...
        print("[{}] Click Add Group Type !".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")))

        time.sleep(600)

        Code = browser.find_element(By.XPATH, '//*[@id="layout-wrapper"]/div[2]/div/div/div/div[2]/div/div/div/form/div[1]/div[1]/input')
        Code.send_keys("10")
